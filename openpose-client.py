...
def main():
    ...
    parser.add_argument("--image-dir", type=str, default="color/", help="OpenPose로 처리할 이미지 파일들이 있는 폴더 (예: color/)") # required=True 제거
    parser.add_argument("--output", type=str, default="result/", help="2D CSV 파일이 저장될 출력 폴더") # required=True 제거
